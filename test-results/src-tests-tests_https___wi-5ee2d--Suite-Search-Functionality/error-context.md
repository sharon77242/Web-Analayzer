...
- main:
  ...
  - search:
    - group:
      ...
      - searchbox "Search Wikipedia": Playwright
      - text: en
      - combobox "en":
        - option "Afrikaans"
        - option "العربية"
        ...
        - option "Русский"
        - option "粵語"
      - link "Playwright Person who writes plays":
        - /url: https://en.wikipedia.org/wiki/Playwright
        - heading "Playwright" [level=3]:
          - emphasis: Playwright
        - paragraph: Person who writes plays
      - link "Playwright (software) End-to-end testing framework":
      ...
      - link "Playwrights Horizons Off-Broadway theater in Manhattan, New York":
        - /url: https://en.wikipedia.org/wiki/Playwrights_Horizons
        - heading "Playwrights Horizons" [level=3]:
          - emphasis: Playwright
          - text: s Horizons
        - paragraph: Off-Broadway theater in Manhattan, New York
      - link "Playwrights Guild of Canada":
        - /url: https://en.wikipedia.org/wiki/Playwrights_Guild_of_Canada
        - heading "Playwrights Guild of Canada" [level=3]:
          - emphasis: Playwright
          - text: s Guild of Canada
        - paragraph
      - link "Playwrights' Company Former American theatrical production company":
        - /url: https://en.wikipedia.org/wiki/Playwrights'_Company
        - heading "Playwrights' Company" [level=3]:
          - emphasis: Playwright
          - text: s' Company
        - paragraph: Former American theatrical production company
      - link "Playwrights '56 American dramatic anthology TV series":
        - /url: https://en.wikipedia.org/wiki/Playwrights_'56
        - heading "Playwrights '56" [level=3]:
          - emphasis: Playwright
          - text: s '56
        - paragraph: American dramatic anthology TV series
      - button "Search"
